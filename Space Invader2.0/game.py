...
from alien import Alien, MysteryShip, Explosion  # Updated import
...
class Game:
            ...
            for laser_sprite in self.spaceship_group.sprite.lasers_group:
                ...
                if aliens_hit:
                    ...
                    for alien in aliens_hit:
                        # Use the alien's color for the explosion
                ...
                if mystery_hit:
                    # Use the mystery ship's red color
    ...
    def check_level_complete(self):
        if len(self.aliens_group.sprites()) == 0:
            ...
            self.current_state = 'level_complete'
    ...
    def next_level(self):
        """ Logic for setting up the next level """
        self.aliens_can_move = False
